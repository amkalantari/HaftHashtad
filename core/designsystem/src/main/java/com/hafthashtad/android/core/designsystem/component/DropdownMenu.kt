...
/**
 * Hafthashtad dropdown menu button with included trailing icon as well as text label and item
 * content slots.
 *
 ...
 */
@Composable
fun <T> HafthashtadDropdownMenuButton(
    items: List<T>,
...
/**
 * Hafthashtad dropdown menu with item content slots. Wraps Material 3 [DropdownMenu] and
 * [DropdownMenuItem].
 *

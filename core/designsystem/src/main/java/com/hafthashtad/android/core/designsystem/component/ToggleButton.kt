...
/**
 * Hafthashtad toggle button with icon and checked icon content slots. Wraps Material 3
 * [IconButton].
 *
...
fun HafthashtadToggleButton(
    ...
    size: Dp = HafthashtadToggleButtonDefaults.ToggleButtonSize,
    iconSize: Dp = HafthashtadToggleButtonDefaults.ToggleButtonIconSize,
...
/**
 * Hafthashtad toggle button default values.
 */
object HafthashtadToggleButtonDefaults {
...
@Composable
fun HafthashtadToggleButtonPreview() {
    HafthashtadToggleButton(
        checked = true,
        onCheckedChange = {},
        icon = {
            Icon(
                imageVector = HafthashtadIcons.Circle,
